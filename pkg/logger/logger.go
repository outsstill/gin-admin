...
func (l *Logger) LogWarnIf(err error) {
	if err != nil {
		l.Warn("Error Occurred:", zap.Error(err))
	}
}
...
func (l *Logger) LogInfoIf(err error) {
	if err != nil {
		l.Info("Error Occurred:", zap.Error(err))
	}
}
